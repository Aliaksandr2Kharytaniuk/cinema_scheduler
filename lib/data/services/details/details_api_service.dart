...
import 'package:cinema_scheduler/data/models/details/details_api_query_parameters.dart';
...
abstract class DetailsApiService extends ChopperService {
  static DetailsApiService create([ChopperClient client]) => _$DetailsApiService(client);
