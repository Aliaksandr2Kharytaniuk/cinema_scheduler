...
import 'package:cinema_scheduler/data/models/data_models/search/search_api_query_parameters.dart';
...
abstract class SearchApiService extends ChopperService {
  static SearchApiService create([ChopperClient client]) =>
      _$SearchApiService(client);
